...
19. treat the bounded Milestone 11 route-catalog corrective slice as complete; the next implementation work should come from the separate browser-review and workflow-continuity sweep unless that sweep promotes another tightly related grouped fix plan

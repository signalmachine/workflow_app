...
20. the next explicitly promoted implementation slice was `web_ui_erp_style_density_correction_plan.md`, and it is now landed in code; the next browser work should come from workflow-validation evidence or a newly promoted bounded follow-up rather than silently widening this corrective slice

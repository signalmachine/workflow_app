...
5. treat the first production-readiness test-expansion checkpoint as landed through the inbound-request lifecycle API mutation seam and cross-org mutation-boundary coverage

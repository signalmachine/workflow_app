...
13. inbound-request reporting now includes persisted cancellation and failure reasons with their timestamps so operator troubleshooting does not require raw table reads

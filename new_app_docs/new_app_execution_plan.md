...
17. this milestone remains in progress because the current browser layer still needs tighter operator continuity, richer drill-downs, and focused refinement across the now-landed review surfaces
18. detailed sequencing and constraints are captured in `web_application_layer_plan.md`
19. this milestone should continue as a sequence of narrow vertical slices rather than one monolithic delivery

...
1. add opt-in provider verification coverage and a focused verification command while keeping default tests provider-independent
2. add the first backend or web contract needed to exercise the live AI path outside direct service calls

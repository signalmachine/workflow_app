...
1. continue Milestone 7 from the landed `/app` browser slices by improving operator continuity and focused exact drill-downs on top of the now-landed inbound-request, inventory, work-order, and audit review surfaces without splitting backend ownership

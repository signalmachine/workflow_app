...
2. continue Milestone 8 from the landed lifecycle-contract pass and keep it centered on shared `/api/...` contract discipline, request-status semantics, review-read consistency, approval-action semantics, and attachment behavior that later lightweight mobile clients will inherit

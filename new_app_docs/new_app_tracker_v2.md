...
34. the remainder of Milestone 14 should now move to seeding `North Harbor Works` with the minimum realistic chart of accounts and master-data baseline needed for these reports and bounded user testing rather than reopening the Slice 1 inbound-request, shell-layout, documentation-truth, grouped-directory, or baseline accounting-report checkpoints
...
4. seed `North Harbor Works` with the minimum realistic chart of accounts and master-data baseline needed for reports, lists, and bounded user testing

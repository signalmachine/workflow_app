...
10. treat Svelte as the browser display and interaction layer while Go remains the owner of business logic, workflow rules, approval semantics, reporting composition, and durable state

...
4. settings, admin, admin accounting setup, admin party setup, admin access controls, and admin inventory setup feel secondary to workflow destinations and do not compete with the main shell

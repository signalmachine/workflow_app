...
21. `reporting` review surfaces for inbound requests, request attachments, linked AI runs, and processed proposals joined to approvals and documents, with stable request references exposed for operator tracking and used directly for request-detail and processed-proposal lookup plus persisted cancellation and failure reasons visible for operator troubleshooting

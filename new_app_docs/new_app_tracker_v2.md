...
5. treat the current production-readiness test-expansion checkpoints as landed through the inbound-request lifecycle API mutation seam, cross-org request mutation-boundary coverage, and cross-org approval-decision no-mutation coverage

...
func TestRegisterWebRoutesServesSPAFallbackAcrossPromotedRouteFamilies(t *testing.T) {
	...
	routes := []string{
		...
		webAccountingPath,
		webAccountingJournalsPath,
		webAccountingControlsPath,
		webAccountingTaxesPath,
		webAccountingTrialPath,
		webAccountingBalancePath,
		webAccountingIncomePath,

...
1. continue the remaining Milestone 5 reporting polish now that stable inbound-request references drive list filtering as well as request-detail and processed-proposal lookup paths

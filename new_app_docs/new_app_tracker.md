...
7. treat the bounded `internal/app` test-suite performance pass as complete in code, tests, and canonical docs
8. next continue live workflow validation on the separate `docs/workflows/` track

...
1. continue Milestone 7 from the landed `/app` browser slices by improving operator continuity and focused drill-downs on top of the now-landed inventory, work-order, and audit review surfaces without splitting backend ownership

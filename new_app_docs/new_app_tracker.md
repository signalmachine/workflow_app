...
1. start Milestone 3 inventory foundation with item, location, and append-only movement truth
2. keep the codebase limited to the approved first-class modules while inventory foundation expands
3. add attachments only where they support approval evidence or document support flows
4. use `new_app_v1_gap_review_from_current_codebase.md` as the reference list of remaining missing foundation areas after the completed accounting slice

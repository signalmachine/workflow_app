...
1. continue Milestone 7 from the landed `/app` browser slices by improving operator continuity and focused exact drill-downs on top of the now-landed inventory, work-order, and audit review surfaces without splitting backend ownership
...
1. widen the landed `/app` browser slices so operators can move from request intake, approval work, and financial-document review into the now-landed inventory, work-order, and audit reporting surfaces on the same backend contracts, then tighten continuity and drill-downs

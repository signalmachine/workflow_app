...
const (
	...
	webAdminMasterDataPath       = "/app/admin/master-data"
	webAdminListsPath            = "/app/admin/lists"
	...
	navigationDashboardPath      = "/api/navigation/dashboard"
	navigationOperationsPath     = "/api/navigation/operations"
	navigationOperationsFeedPath = "/api/navigation/operations-feed"
	navigationReviewPath         = "/api/navigation/review"
	navigationAgentChatPath      = "/api/navigation/agent-chat"
	navigationRouteCatalogPath   = "/api/navigation/routes"
...
func newAgentAPIHandlerWithDependencies(loader queuedInboundRequestProcessorLoader, submissionService inboundRequestSubmitter, reviewService operatorReviewReader, approvalService approvalDecisionService, proposalApproval proposalApprovalService, accountingAdmin accountingAdminService, authService browserSessionService, optionalServices ...any) http.Handler {
	...
	mux.HandleFunc(navigationReviewPath, handler.handleGetNavigationReview)
	mux.HandleFunc(navigationAgentChatPath, handler.handleGetNavigationAgentChat)
	mux.HandleFunc(navigationRouteCatalogPath, handler.handleGetNavigationRouteCatalog)

	...
	data := webAdminData{
		...
		MaintenanceFamilies: []webAdminFamily{
			...
			},
			{
				...
				Summary:      "User access, role control, approval visibility, and audit continuity stay grouped under one privileged maintenance posture.",
				CurrentHref:  webAdminAccessPath,
				CurrentLabel: "Open access controls",
				NextSlice:    "Current slice: bounded admin-only user membership provisioning and role updates now reuse the shared identity and session service seam.",
			},
			{
				Title:        "Inventory setup",
				Summary:      "Item and location master data should stay on the shared inventory foundation instead of being implied only through downstream movement review.",
				CurrentHref:  webAdminInventoryPath,
				CurrentLabel: "Open inventory setup",
				NextSlice:    "Current slice: bounded admin-only inventory maintenance now exposes item and location list plus create controls on the shared inventory service seam.",
			},
		},
		AdminActions: []webHomeAction{
			...
			{Title: "Open access controls", Summary: "Provision org users and update membership roles without turning Admin into a broad identity console.", Href: webAdminAccessPath},
			{Title: "Open inventory setup", Summary: "Create inventory items and locations before downstream stock, movement, and reconciliation work depends on them.", Href: webAdminInventoryPath},

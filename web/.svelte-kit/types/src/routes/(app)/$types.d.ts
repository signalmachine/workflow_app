...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/admin" | "/(app)/admin/access" | "/(app)/admin/accounting" | "/(app)/admin/inventory" | "/(app)/admin/parties" | "/(app)/inventory" | "/(app)/operations" | "/(app)/review" | "/(app)/settings"
